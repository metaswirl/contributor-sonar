...
public class FileSourceTest {
    ...
    public void testEmitting() throws Exception {
        ...
        final FileSource<TestEntry> source = new FileSource<>(
                sourceFile.getAbsolutePath(),
                new TestEntryDeserializer(),
                null, 1, sleepTimes::add);
    ...
    private File createFile(String... lines) throws IOException {
        final File sourceFile = new File(temporaryDirectory, "random-source-file-" + System.currentTimeMillis());
